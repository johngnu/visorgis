<%-- 
    Document   : disperso
    Created on : Nov 1, 2020, 6:10:35 PM
...
<html lang="es">
    ...
    <script type="text/javascript">
        ...
        domain.objects.popup = function (feature, map) {
            ...
            predioDetails += '<strong>cod_ine: ' + feature.data.idcomunidad + '</strong><br>';
        ...
        domain.objects.mapa = function (options) {
            ...
            this.canvas.events.on({
                featureadded: function (e) {
                    ...
                    $.ajax({
                        url: '<c:url value="/disperso/ficha/selected"/>',
                        type: "GET",
                        ...
                        success: function (data) {
                            if (data.success) {
                                ...
                                data.data.forEach(function (item, index) {
                                    ...
                                    ids.push(item.idcomunidad);
                                });

                                $('#moreinfo').modal('toggle');
                                $.ajax({
                                    url: '<c:url value="/disperso/ficha/data"/>',
                                    type: "POST",
                                    ...
                                    success: function (data) {
                                        ...
                                        $("#docContent").html('<embed src="<c:url value="/disperso/ficha/pdf?time="/>' + time + '" width="100%" height="200"><br/><a class="btn btn-primary btn-sm" href="<c:url value="/disperso/ficha/pdf?download=true"/>">Descargar</a>')
