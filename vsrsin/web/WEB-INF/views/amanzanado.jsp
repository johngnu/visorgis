        ...
        domain.objects.mapa = function (options) {
            ...
            this.canvas.events.on({
                featureadded: function (e) {
                    ...
                    $.ajax({
                        url: '<c:url value="/amanzanado/ficha/selected"/>',
                        type: "GET",
                        ...
                        success: function (data) {
                            if (data.success) {
                                ...
                                $.ajax({
                                    url: '<c:url value="/amanzanado/ficha/data"/>',
                                    type: "POST",
                                    ...
                                    success: function (data) {
                                        ...
                                        $("#docContent").html('<embed src="<c:url value="/amanzanado/ficha/pdf?time="/>' + time + '" width="100%" height="200"><br/><a class="btn btn-primary btn-sm" href="<c:url value="/amanzanado/ficha/pdf?download=true"/>">Descargar</a>')
